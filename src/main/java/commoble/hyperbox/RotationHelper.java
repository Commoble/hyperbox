...
public class RotationHelper
{
	...
	// vanilla's horizontal direction indices from 0 to 3 are south,west,north,east
	// we realized this after writing the rest of this table
	// we had been using north, east, south, west
	// this is a converter for that
	...
	/** Get the rotation index for a 24-orientation block after rotating the blockstate **/
	...
	/** Get the rotation index for a 24-orientation block after mirroring the blockstate **/
